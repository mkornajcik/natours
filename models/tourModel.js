...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      maxlength: [
        40,
        'A tours name must have less or equal than 40 characters',
      ],
      minlength: [10, 'A tours name must have at lest 10 characters'],
    ...
    imageCover: {
      type: String,
      require: [true, 'A tour must have a cover picture.'],
    },
    images: [String],
